    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_category', models.CharField(choices=[('work', 'Work'), ('personal', 'Personal'), ('study', 'Study'), ('health', 'Health'), ('finance', 'Finance'), ('other', 'Other')], default='personal', max_length=50)),
